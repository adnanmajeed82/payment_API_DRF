...
SECRET_KEY = 'django-insecure-+w2@#^4p%fjnlqj&v2euu+@9b#e!tlq--%yk!m+gb+aw+qhl+z'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'rest_framework.permissions.IsAuthenticated',  # Add this for global auth requirement
    ),
